    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="row mb-3 mt-0">
          <div class="col-md-2">
            <a href="{{ url('/superadmin/category/create') }}">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle d-inline-flex">
                        <form action="/superadmin/category/{{ $category['id'] }}/edit" method="GET">
                          <button type="submit" class="btn btn-outline-primary btn-xs rounded-lg py-0 px-1 mx-1">
                            <i class="fas fa-edit"></i>
                          </button>
                        </form>
                        <form action="/superadmin/category/{{ $category['id'] }}" method="POST">
                          @csrf
                          @method('DELETE')
