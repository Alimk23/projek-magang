      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ url('/superadmin/category') }}" method="post">
                    @csrf
                          ...
                          <div class="row">
                            <div class="col d-flex flex-md-row flex-column">
                              <div class="form-group mr-lg-4 mr-sm-2 mr-1">
                                  <select class="form-control select2-allow-clear select2Minimal @error('icon') is-invalid @enderror" name="icon" id="icon" required>
