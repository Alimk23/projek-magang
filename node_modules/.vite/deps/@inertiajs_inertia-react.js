  ...
  "node_modules/@inertiajs/inertia/node_modules/axios/package.json"(exports, module) {
    module.exports = {
      _args: [
        [
          "axios@0.21.4",
          "F:\\Coding\\Web\\laravel-apps\\hobisedekah"
        ]
      ],
      _development: true,
      _from: "axios@0.21.4",
      ...
      _spec: "0.21.4",
      _where: "F:\\Coding\\Web\\laravel-apps\\hobisedekah",
      author: {
        name: "Matt Zabriskie"
      },
      browser: {
...
var require_dist2 = __commonJS({
  "node_modules/@inertiajs/inertia-react/dist/index.js"(exports) {
    ...
    function s(e2) {
      var n2 = e2.children, t2 = e2.initialPage, u2 = e2.resolveComponent, s2 = e2.titleCallback, l2 = e2.onHeadUpdate, f2 = r.useState({ component: e2.initialComponent || null, page: t2, key: null }), p2 = f2[0], d = f2[1], v = r.useMemo(function() {
    ...
    var p = r.forwardRef(function(e2, n2) {
      var t2 = e2.children, u2 = e2.as, a2 = void 0 === u2 ? "a" : u2, c2 = e2.data, s2 = void 0 === c2 ? {} : c2, l2 = e2.href, p2 = e2.method, d = void 0 === p2 ? "get" : p2, v = e2.preserveScroll, m = void 0 !== v && v, y = e2.preserveState, h = void 0 === y ? null : y, g = e2.replace, S = void 0 !== g && g, k = e2.only, C = void 0 === k ? [] : k, b = e2.headers, P = void 0 === b ? {} : b, E = e2.queryStringArrayFormat, x = void 0 === E ? "brackets" : E, w = e2.onClick, I = void 0 === w ? f : w, T = e2.onCancelToken, O = void 0 === T ? f : T, j = e2.onBefore, A = void 0 === j ? f : j, L = e2.onStart, F = void 0 === L ? f : L, H = e2.onProgress, R = void 0 === H ? f : H, B = e2.onFinish, D = void 0 === B ? f : B, q = e2.onCancel, M = void 0 === q ? f : q, N = e2.onSuccess, U = void 0 === N ? f : N, J = e2.onError, W = void 0 === J ? f : J, _ = function(e3, n3) {
        if (null == e3)
          return {};
        ...
        return o2;
      }(e2, ["children", "as", "data", "href", "method", "preserveScroll", "preserveState", "replace", "only", "headers", "queryStringArrayFormat", "onClick", "onCancelToken", "onBefore", "onStart", "onProgress", "onFinish", "onCancel", "onSuccess", "onError"]), Q = r.useCallback(function(e3) {
        I(e3), o.shouldIntercept(e3) && (e3.preventDefault(), o.Inertia.visit(l2, { data: s2, method: d, preserveScroll: m, preserveState: null != h ? h : "get" !== d, replace: S, only: C, headers: P, onCancelToken: O, onBefore: A, onStart: F, onProgress: R, onFinish: D, onCancel: M, onSuccess: U, onError: W }));
      }, [s2, l2, d, m, h, S, C, P, I, O, A, F, R, D, M, U, W]);
      a2 = a2.toLowerCase(), d = d.toLowerCase();
      var z = o.mergeDataIntoQueryString(d, l2 || "", s2, x);
      return l2 = z[0], s2 = z[1], "a" === a2 && "get" !== d && console.warn('Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.\n\nPlease specify a more appropriate element using the "as" attribute. For example:\n\n<Link href="' + l2 + '" method="' + d + '" as="button">...</Link>'), r.createElement(a2, i({}, _, "a" === a2 ? { href: l2 } : {}, { ref: n2, onClick: Q }), t2);
    });
    exports.App = s, exports.Head = l, exports.InertiaApp = s, exports.InertiaHead = l, exports.InertiaLink = p, exports.Link = p, exports.app = s, exports.createInertiaApp = function(e2) {
      try {
        var n2, t2, o2, i2, u2, a2, c2;
        t2 = void 0 === (n2 = e2.id) ? "app" : n2, o2 = e2.resolve, i2 = e2.setup, u2 = e2.title, a2 = e2.page, c2 = e2.render;
        var l2 = "undefined" == typeof window, f2 = l2 ? null : document.getElementById(t2), p2 = a2 || JSON.parse(f2.dataset.page), d = function(e3) {
          return Promise.resolve(o2(e3)).then(function(e4) {
            return e4.default || e4;
          });
        }, v = [];
        return Promise.resolve(d(p2.component).then(function(e3) {
          return i2({ el: f2, App: s, props: { initialPage: p2, initialComponent: e3, resolveComponent: d, titleCallback: u2, onHeadUpdate: l2 ? function(e4) {
            return v = e4;
          } : null } });
        })).then(function(e3) {
          return function() {
    ...
    }, exports.link = p, exports.useForm = function() {
      var e2 = [].slice.call(arguments), t2 = r.useRef(null), a2 = "string" == typeof e2[0] ? e2[0] : null, c2 = r.useState(("string" == typeof e2[0] ? e2[1] : e2[0]) || {}), s2 = c2[0], l2 = c2[1], f2 = r.useRef(null), p2 = r.useRef(null), d = a2 ? u(s2, a2 + ":data") : r.useState(s2), v = d[0], m = d[1], y = a2 ? u({}, a2 + ":errors") : r.useState({}), h = y[0], g = y[1], S = r.useState(false), k = S[0], C = S[1], b = r.useState(false), P = b[0], E = b[1], x = r.useState(null), w = x[0], I = x[1], T = r.useState(false), O = T[0], j = T[1], A = r.useState(false), L = A[0], F = A[1], H = function(e3) {
        return e3;
      };
